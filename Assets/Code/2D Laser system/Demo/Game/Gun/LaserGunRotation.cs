...
namespace _2D_Laser_system.Demo.Game.Gun
{
    public class LaserGunRotation : MonoBehaviour
    {
        ...
        private void Update()
        {
            Vector2 worldMousePosition = _useMouse ? UnityEngine.Camera.main.ScreenToWorldPoint(Input.mousePosition) : _target.position;
